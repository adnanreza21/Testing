...
public class BathActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final MediaPlayer mp = MediaPlayer.create(this, R.raw.mandi_indo);
        final MediaPlayer mp1 = MediaPlayer.create(this, R.raw.mandi_jawa);
        final MediaPlayer mp2 = MediaPlayer.create(this, R.raw.tidur_indo);
        final MediaPlayer mp3 = MediaPlayer.create(this, R.raw.tidur_jawa);
